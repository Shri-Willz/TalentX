...
export default function LearningPage() {
  ...
  return (
    <>
      <Navbar />
      <div className="min-h-screen bg-background p-4 sm:p-6 md:p-10 flex flex-col items-center text-white relative">
        {/* Header */}
        <header className="w-full max-w-6xl flex justify-between items-center mb-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <button className="px-4 py-2 bg-accent text-white rounded-full text-sm shadow hover:bg-accent/20 transition flex items-center gap-2">
        ...
        <div className="w-full max-w-6xl bg-white/5 backdrop-blur-xl rounded-2xl shadow-lg p-6 border border-white/10 hover:shadow-xl transition">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex flex-col items-center">
              <div className="relative w-28 h-28 sm:w-32 sm:h-32 rounded-full bg-accent flex items-center justify-center text-white text-2xl font-bold shadow-md">
                78%
              </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-6 text-center">
            ...
            { label: "Goal Progress", value: "85%" }].map((item, i) => (
              <div key={i} className="bg-accent/5 backdrop-blur-md rounded-xl p-3  shadow-sm hover:shadow-md transition">
          ...
          {pillars.map((pillar, i) => (
            <div key={i} className="bg-white/5 backdrop-blur-xl rounded-2xl shadow-md p-5 border border-white/10 hover:shadow-lg hover:scale-[1.02] transition-all">
              ...
              <div className="flex flex-col gap-4">
                <Button className="flex bg-accent w-full text-white rounded-2xl">
                  {pillar.primary} <ChevronRight size={14} />
                </Button>
                <Button className="bg-accent/10 w-full rounded-2xl hover:border hover:border-accent text-white">{pillar.secondary}</Button>
                <Button className="bg-accent/10 w-full rounded-2xl text-white">{pillar.view}</Button>
              </div>
            </div>
          ))}
        </section>
        ...
        <section className="w-full max-w-6xl mt-10  backdrop-blur-xl rounded-2xl shadow-md p-6 hover:shadow-lg transition">
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4  bg-accent/5 border-accent/20 p-4 rounded-2xl">
            ...
            <div className="
            flex flex-col  bg-accent/5 border-accent/20 p-4 rounded-2xl">
